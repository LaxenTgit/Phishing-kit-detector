"""
Core orchestrator — PhishingDetector.
Drives the analysis pipeline and returns a typed AnalysisResult.
Can also be used as a library:

    from phishing_detector import PhishingDetector
    result = PhishingDetector().analyze("https://suspicious.example.com")
"""
